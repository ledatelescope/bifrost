...
NBEAMS = 32
NACCUMULATE = 32
NSAMPLES_PER_BLOCK = (NACCUMULATE * NTHREADS/WARP_SIZE)
NSAMPLES = (NSAMPLES_PER_BLOCK * 100)
NCHANNELS = 320
...
np.random.seed(123)
v = np.random.randint(64, size=(NCHANNELS, NSAMPLES, NPOL, NANTENNAS, 2), dtype='int8')
